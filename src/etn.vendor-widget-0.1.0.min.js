document.addEventListener("DOMContentLoaded",function(){const langs={en:"Scan with the app or click to pay"};var els=document.querySelectorAll('[data-etn-vendor]');for(i=0;i<els.length;++i){var code=els[i].getAttribute("data-etn-vendor");var lang=els[i].getAttribute("data-etn-lang");var text='';if(typeof(lang)==='undefined'||lang===null){lang='en'}
